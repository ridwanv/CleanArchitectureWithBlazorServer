...
namespace CleanArchitecture.Blazor.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240214125233_supplierQuestionaire")]
    partial class supplierQuestionaire
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CleanArchitecture.Blazor.Domain.Entities.QuestionaireResponse", b =>
                {
                    ...
                    b.Property<Guid>("AnswerFormatId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("SupplierQuestionaireQuestionaireId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("SupplierQuestionaireSupplierId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("SupplierQuestionaireId", "QuestionId");

                    b.HasIndex("AnswerFormatId");

                    b.HasIndex("SupplierQuestionaireSupplierId", "SupplierQuestionaireQuestionaireId");

                    b.ToTable("QuestionaireResponse");
                });
            ...
            modelBuilder.Entity("CleanArchitecture.Blazor.Domain.Entities.SupplierQuestionaire", b =>
                {
                    ...
                    b.HasKey("SupplierId", "QuestionaireId");
            ...
            modelBuilder.Entity("CleanArchitecture.Blazor.Domain.Entities.QuestionaireResponse", b =>
                {
                    b.HasOne("CleanArchitecture.Blazor.Domain.Entities.AnswerFormat", "AnswerFormat")
                        .WithMany()
                        .HasForeignKey("AnswerFormatId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("CleanArchitecture.Blazor.Domain.Entities.SupplierQuestionaire", "SupplierQuestionaire")
                        ...
                        .HasForeignKey("SupplierQuestionaireSupplierId", "SupplierQuestionaireQuestionaireId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AnswerFormat");
