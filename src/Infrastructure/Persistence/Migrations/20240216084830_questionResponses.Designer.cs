...
namespace CleanArchitecture.Blazor.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240216084830_questionResponses")]
    partial class questionResponses
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CleanArchitecture.Blazor.Domain.Entities.QuestionResponseDateTime", b =>
                {
                    b.HasBaseType("CleanArchitecture.Blazor.Domain.Entities.QuestionResponse");

                    b.HasDiscriminator().HasValue("QuestionResponseDateTime");
                });

            modelBuilder.Entity("CleanArchitecture.Blazor.Domain.Entities.QuestionResponseLongText", b =>
                {
                    b.HasBaseType("CleanArchitecture.Blazor.Domain.Entities.QuestionResponse");

                    b.HasDiscriminator().HasValue("QuestionResponseLongText");
                });

            modelBuilder.Entity("CleanArchitecture.Blazor.Domain.Entities.QuestionResponseMultipleChoice", b =>
                {
                    b.HasBaseType("CleanArchitecture.Blazor.Domain.Entities.QuestionResponse");
                    ...
                    b.Property<Guid>("QuestionResponseId1")
                        .HasColumnType("uniqueidentifier");

                    b.HasIndex("QuestionResponseId1");

                    b.HasDiscriminator().HasValue("QuestionResponseMultipleChoice");
                });

            modelBuilder.Entity("CleanArchitecture.Blazor.Domain.Entities.QuestionResponseShortText", b =>
                {
                    b.HasBaseType("CleanArchitecture.Blazor.Domain.Entities.QuestionResponse");

                    b.HasDiscriminator().HasValue("QuestionResponseShortText");
                });
            ...
            modelBuilder.Entity("CleanArchitecture.Blazor.Domain.Entities.QuestionResponseMultipleChoice", b =>
                {
                    b.HasOne("CleanArchitecture.Blazor.Domain.Entities.QuestionResponse", "QuestionResponse")
                        .WithMany()
                        .HasForeignKey("QuestionResponseId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
